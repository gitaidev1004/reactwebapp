...
// Register.js
function Register() {
  const [form, setForm] = useState({ username: "", password: "", email: "", name: "", phone: "", address: "" });
    ...
    <div className="container" style={{ paddingTop: 150, paddingBottom:100 }}>
      ...
      >
        ...
        <div className="mb-3">
          ...
          {usernameAvailable === false && <p style={{ color: "red", marginTop: 8 }}>이미 사용 중인 아이디입니다</p>}
          {usernameAvailable === true && <p style={{ color: "green", marginTop: 8 }}>사용 가능한 아이디입니다</p>}
        </div>

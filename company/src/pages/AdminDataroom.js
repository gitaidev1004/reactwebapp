        ...
        <div style={{ width: '100%', maxWidth: 1448, margin: '0 auto', padding: '20px', paddingTop:100 }} >
            ...
            <div style={{ marginTop: 30, display: 'flex' }}>
                <nav style={{ padding: '10px 0', width: '20%' }}>
                    ...
                    <Link style={{ display: 'block', color: '#000', fontWeight: 'bold', marginBottom: 5 }} to="/admindataroom">자료실</Link>
                            ...
                            <tbody>
                                {items.map(item => (
                                    <tr style={{ verticalAlign: 'middle' }} key={item.id}>
                                        ...
                                        <td style={{ width: '20%' }}>{formatDate(item.resdate)}</td>

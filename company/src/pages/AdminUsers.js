        ...
        <div style={{ width: '100%', maxWidth: 1448, margin: '0 auto', padding: '20px', paddingTop:100 }}>
            ...
            <div style={{ marginTop: 30, display: 'flex' }}>
                <nav style={{ padding: '10px 0', width: '20%' }}>
                    <Link style={{ display: 'block', color: '#000', fontWeight: 'bold', marginBottom:5 }} to="/adminusers">회원관리</Link>
                ...
                <div style={{ width: '100%', padding: '10px 0', borderLeft: '1px solid #e5e5e5' }}>
                    <p style={{ paddingLeft: 20, paddingBottom: 10, marginBottom: 0, width: '100%', borderBottom: '1px solid #e5e5e5', fontWeight: 'bold' }}>회원관리</p>
                    <div style={{ padding: 20, marginTop:60 }}>
                        ...
                        {/* 페이지네이션 */}
                        <div style={{ marginTop: 30, display: 'flex', justifyContent: 'center', gap: '8px', flexWrap: 'wrap' }}>
                            {/* 이전 버튼 */}
                            <button

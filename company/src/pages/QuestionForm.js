...
const QuestionForm = () => {
  ...
  return (
    <div className="container mb-5" style={{ maxWidth: 1200, paddingTop:76 }}>
      <h2 style={{ textAlign: 'center', marginTop: 100, fontSize: 56, fontWeight: 'bold', marginBottom: 0 }} className="mb-4">1:1문의</h2>
      <p style={{ marginTop: 50, textAlign: 'center', marginBottom: 0 }}>문의사항에 빠르고 친절하게 답변해 드리겠습니다.</p>
      <p style={{ marginTop: 50, fontWeight: 'bold' }}>문의 사항을 상세히 작성해주세요.</p>
      <div style={{ borderBottom: '1px solid #e5e5e5' }}>
        <p style={{ float: 'right' }} class="text_right font_sm">
          <em style={{ color: 'red' }} class="text_warning">*</em> 입력 항목
        </p>
      ...
      <form style={{ marginTop: 50 }} onSubmit={handleSubmit}>
        ...
        <div style={{ textAlign: 'center', marginTop: 30 }}>
          <button type="submit" style={{ borderRadius: 0 }} className="btn btn-dark px-5">등록</button>
        </div>
      </form>
